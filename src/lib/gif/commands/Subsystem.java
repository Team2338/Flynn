...
public abstract class Subsystem implements NamedSendable {
   ...
   *         subsystem
   */
  protected final void setDefaultCommand(Command command) {
    if (command == null) {
      defaultCommand = null;
    } else {
      boolean found = false;
   ...
   */
  protected final Command getDefaultCommand() {
   ...
   */
  final void setCurrentCommand(Command command) {
