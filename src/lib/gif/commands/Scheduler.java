...
import lib.gif.LinkedListElement;
import lib.gif.Set;
import lib.gif.buttons.Trigger.ButtonScheduler;
...
public class Scheduler implements NamedSendable {
   ...
   */
  private Hashtable<Command, LinkedListElement> commandTable = new Hashtable<Command, LinkedListElement>();
  /**
   * The {@link Set} of all {@link Subsystem Subsystems}
   */
  private Set<Subsystem> subsystems = new Set<Subsystem>();
  /**
   ...
   */
  private Vector<Command> additions = new Vector<Command>();
  ...
  public void addButton(ButtonScheduler button) {
    if (buttons == null) {
      buttons = new Vector<ButtonScheduler>();
    }
